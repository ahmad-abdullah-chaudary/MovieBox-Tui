    ...
    pub fn find_compatible_asset(&self, platform: TargetPlatform) -> Option<ReleaseAsset> {
        ...
        if self.assets.is_empty() && !self.tag_name.is_empty() {
            return Some(ReleaseAsset {
                ...
                download_url: format!(
                    "https://github.com/ahmad-abdullah-chaudary/MovieBox-Tui/releases/download/{}/{expected}",
                    self.tag_name
                ),
                size: None,
            });
    ...
    pub fn find_checksum_asset(&self) -> Option<ReleaseAsset> {
        ...
        if self.assets.is_empty() && !self.tag_name.is_empty() {
            return Some(ReleaseAsset {
                ...
                download_url: format!(
                    "https://github.com/ahmad-abdullah-chaudary/MovieBox-Tui/releases/download/{}/SHA256SUMS",
                    self.tag_name
                ),
                size: None,
            });
...
mod tests {
    ...
    fn test_synthetic_asset_url_generation_on_empty_assets() {
        ...
        assert_eq!(
            ...
            "https://github.com/ahmad-abdullah-chaudary/MovieBox-Tui/releases/download/v0.1.16/MovieBox_Linux_x64.tar.gz"
        );
        ...
        assert_eq!(
            ...
            "https://github.com/ahmad-abdullah-chaudary/MovieBox-Tui/releases/download/v0.1.16/MovieBox_macOS_Universal.tar.gz"
        );
        ...
        assert_eq!(
            ...
            "https://github.com/ahmad-abdullah-chaudary/MovieBox-Tui/releases/download/v0.1.16/SHA256SUMS"
        );
    }
