...
pub fn build_help_columns(
    ...
    left.push(help_section_header("Playback Controls", theme));
    if state.is_playing {
        left.push(help_row(
            "Space / P",
        ...
        left.push(help_row("x", "Stop playback without leaving app", theme));
        left.push(help_row(
            "q",
            "First press stops playback; second press quits app",
            theme,
        ));
    } else {
        left.push(help_row(
        ...
        left.push(help_row(
            "q",
            "When playing, first press stops playback, second press quits",
            theme,
        ));
    }
