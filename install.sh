...
REPO="ahmad-abdullah-chaudary/MovieBox-Tui"
...
USAGE:
    curl -fsSL https://raw.githubusercontent.com/ahmad-abdullah-chaudary/MovieBox-Tui/main/install.sh | bash -s -- [OPTIONS]
    ./install.sh [OPTIONS]
